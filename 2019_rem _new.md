...
$$
(-y_u\sin(\theta))\,X - f\,Y + (y_u\cos(\theta))\,Z
= \frac{b}{2}y_u\sin(\theta)
$$
(7.34)

$$
(x_{uR}\sin(\theta) - f\cos(\theta))\,X
+ (x_{uR}\cos(\theta) + f\sin(\theta))\,Z
= -\left(\frac{b}{2}x_{uR}\sin(\theta) - \frac{b}{2}f\right)
$$ (7.35)
...
$$
s^T \cdot n_p = \|s\|_2 \cdot \|n_p\|_2 \cdot \cos \alpha,
$$
(7.39)

$$
\cos \alpha = \frac{s^T \cdot n_p}{\|s\|_2 \cdot \|n_p\|_2}.
$$ 
(7.40)
...
\[
\frac{\partial^2 Z}{\partial x \partial y} = \frac{\partial^2 Z}{\partial y \partial x} \tag{7.48}
\]
...
\[
Z(x + 1, y + 1) = Z(x, y + 1) + \frac{1}{2}\left(a_{x, y + 1} + a_{x + 1, y + 1}\right). \tag{7.51}
\]
...
\[
Z(x + 1, y + 1) = Z(x + 1, y) + \frac{1}{2}\left(b_{x + 1, y} + b_{x + 1, y + 1}\right). \tag{7.52}
\]
...
\[
Z(x + 1, y + 1) = \frac{1}{2}\bigl(Z(x, y + 1) + Z(x + 1, y)\bigr) + \frac{1}{4}\bigl(a_{x, y + 1} + a_{x + 1, y + 1} + b_{x + 1, y} + b_{x + 1, y + 1}\bigr). \tag{7.53}
\]
...
\[
Z(x - 1, N_{\text{rows}}) = Z(x, N_{\text{rows}}) - a_{x, N_{\text{rows}}}, \tag{7.56}
\]


\[
Z(N_{\text{cols}}, y - 1) = Z(N_{\text{cols}}, y) - b_{N_{\text{cols}}, y}. \tag{7.57}
\]
...
\[
Z(x-1, y-1) = \frac{1}{2} \bigl(Z(x-1, y) + Z(x, y-1)\bigr) - \frac{1}{4} \bigl(a_{x-1, y} + a_{x, y} + b_{x, y-1} + b_{x, y}\bigr). \tag{7.58}
\]
...
\[
E_{\text{data}}(Z) = \sum_{\Omega} \bigl[(Z_x - a)^2 + (Z_y - b)^2\bigr] + \lambda_0 \sum_{\Omega} \bigl[(Z_{xx} - a_x)^2 + (Z_{yy} - b_y)^2\bigr]. \tag{7.60}
\]
...
\[
E_{\text{smooth}}(Z) = \lambda_1 \sum_{\Omega} \left(Z_x^2 + Z_y^2\right) + \lambda_2 \sum_{\Omega} \left(Z_{xx}^2 + 2Z_{xy}^2 + Z_{yy}^2\right), \tag{7.61}
\]
...
\[
E_{\text{total}}(Z) = E_{\text{data}}(Z) + E_{\text{smooth}}(Z) \tag{7.62}
\]
...
\[
\mathcal{Z}(u, v) = \frac{1}{|\Omega|} \sum_{\Omega} Z(x, y) \cdot \exp \left[ -i 2 \pi \left( \frac{x u}{N_{\text{cols}}} + \frac{y v}{N_{\text{rows}}} \right) \right], \tag{7.63}
\]
...
\[
Z(x, y) = \sum_{\Omega} \mathcal{Z}(u, v) \cdot \exp \left[ i 2 \pi \left( \frac{x u}{N_{\text{cols}}} + \frac{y v}{N_{\text{rows}}} \right) \right], \tag{7.64}
\]
...
\[
(u^2 \mathcal{Z} + i u \mathcal{A} + v^2 \mathcal{Z} + i v \mathcal{B}) + \lambda_0 (u^4 \mathcal{Z} + i u^3 \mathcal{A} + v^4 \mathcal{Z} + i v^3 \mathcal{B}) + \lambda_1 (u^2 + v^2) \mathcal{Z} + \lambda_2 (u^4 + 2 u^2 v^2 + v^4) \mathcal{Z} = 0. \tag{7.67}
\]
...
\[
\bigl[\lambda_0 (u^4 + v^4) + (1 + \lambda_1)(u^2 + v^2) + \lambda_2 (u^2 + v^2)^2\bigr] \mathcal{Z}(u, v) + i(u + \lambda_0 u^3) \mathcal{A}(u, v) + i(v + \lambda_0 v^3) \mathcal{B}(u, v) = 0. \tag{7.68}
\]
